...
with tab1:
    ...
    st.text('Unit Kurikulum Disetujui Semester 1: Jumlah unit kurikuler yang disetujui pada semester 1')
    st.text('Nilai Unit Kurikulum Semester 1: Nilai rata-rata pada semester 1 (antara 0 dan 20)')
    st.text('Unit Kurikulum Disetujui Semester 2: Jumlah unit kurikuler yang disetujui pada semester 2')
    st.text('Nilai Unit Kurikulum Semester 2: Nilai rata-rata pada semester 2 (antara 0 dan 20)')
    st.text('Status Pembayaran Biaya Kuliah: Status pembayaran biaya kuliah (sudah dibayar atau belum)')
    st.text('Status Hutang: Status apakah mahasiswa memiliki hutang (ya atau tidak)')
    st.text('Status Beasiswa: Status apakah mahasiswa menerima beasiswa (ya atau tidak)')
    st.text('Usia Saat Mendaftar: Usia siswa saat mendaftar')
    st.text('Jenis Kelamin: Jenis kelamin siswa (laki-laki atau perempuan)')
    st.text('Mode Aplikasi: Mode aplikasi atau metode pendaftaran')
